...
const en = {
  translation: {
    ...
    replace_in_current_table: "Current table",
    replace_in_all_tables: "All tables",
    n_matches_found: "{{count}} match(es) found",
    no_matches_found: "No matches found",
    n_replacements_made: "{{count}} replacement(s) made",
    field_in_table: "{{field}} in {{table}}",
    press_esc_to_close: "Press Esc to close",
    batch_replace_fields: "Batch replace field names",
  },
};
